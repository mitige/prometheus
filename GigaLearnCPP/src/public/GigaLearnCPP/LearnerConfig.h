...
namespace GGL {
	...
	struct LearnerConfig {
		...
		RLGC::EnvPhysicsBackend physicsBackend = RLGC::EnvPhysicsBackend::ROCKETSIM_CPU;
		...
		// RocketSimCuda fast path: skip CPU GameState sync when no callbacks/metrics/rendering need it.
		bool cudaNoCpuWorldState = false;
